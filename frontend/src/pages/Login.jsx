      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md glass-card p-8 shadow-2xl relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-slate-500 mt-1">Sign in to your SkillBridge AI account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-10 pr-10 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-900 dark:text-white focus:ring-2 focus:ring-teal-500 outline-none text-sm"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <Link to="/forgot-password" className="font-semibold text-teal-600 hover:text-teal-700">
                Forgot Password?
              </Link>
            </div>
            ...
            <button
              disabled={loading}
              type="submit"
              className="w-full py-3 rounded-xl font-bold text-white bg-gradient-to-r from-teal-600 via-cyan-600 to-amber-500 hover:opacity-95 shadow-lg shadow-teal-500/20 flex items-center justify-center gap-2 transition-all disabled:opacity-50"
            >
              {loading ? (
          ...
          <p className="mt-6 text-center text-xs text-slate-500">
            ...
            <Link to="/register" className="font-bold text-teal-600 hover:text-teal-700">
              Sign Up Free <ArrowRight className="w-3 h-3 inline" />
            </Link>
          </p>
        </div>
      </main>
